...
When your reply contains code blocks (>5 lines), tables, SVG/Mermaid, or any content that requires rendering, write to a temp file and include the path in your reply. The system will detect temp file paths and send them as attachments. The exact file naming convention is provided by the channel-specific instructions below.
